...
class MAGNN_gc(nn.Module):
    def __init__(self,
        ...
        # this is hence the fc layer (Ryan's modifications)
        self.layers.append(nn.Linear(hidden_dim, num_classes, bias=True))
    ...
    def forward(self, inputs, target_node_indices):
        ...
        # print(h_mean)
        # FC layer
        # @param logits: the normalized probability vector
        # @param h: embeddings
        logits = self.layers[-1](h_mean)
